...
model.load_weights_from_file('../Disentangling/params/betaVAE_Cloth_prev_human12_dimZ_50alpha_0.05')
...
# all_inputs = uts.load_images_sequence('../Experiments/Dataset/Toy_Example/1', 156, image_size)
#
#
# # plot_r = pr.plot_task_map('../Experiments/Dataset/Toy_Example', 100, 0.2, 345.6, sample_sequence, device)
plot_r = pr.plot_task_map('../Experiments/Dataset/Cloth_prev', dimz, 0.05, 172.8, None, device)
plot_r.save_results_41(model, "beta_VAE_mixedHR", mixedHR, "mixedHR")
plot_r.save_results_41(model, "beta_VAE_final_states", finalImages, "final states")
# zt_marks, score, zt_ranges = dis_utils.get_time_varying_marks(all_inputs, model, device, 0.5)
# print("score:")
# print(score)
# print(zt_marks)
# print(zt_ranges)
#
# np.save('results/ToyExample_dimZ50_0.1_ZtMarks', zt_marks)
# np.save('results/ToyExample_dimZ50_0.1_stateRanges', zt_ranges)
...
# plot_r.save_results_4(model, 'save_test')
# zt_marks = np.load('results/ToyExample_dimZ50_0.1_ZtMarks.npy')
#
...
#     with torch.no_grad():
#         _, Zts, meanz, logvar = model(seqs.to(device))
#         lean_states = time_varying_states(meanz.to('cpu').numpy(), zt_marks)
#         return lean_states
#
