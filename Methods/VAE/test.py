...
mixedHR = uts.load_images_sequence('../../Experiments/Dataset/BlocksV2/mixedHR', 200, image_size)
finalImages = uts.load_images_sequence('../../Experiments/Dataset/BlocksV2/final', 20, image_size)
plot_r = pr.plot_task_map(dimz, '../../Experiments/Dataset/BlocksV2', None, device)
