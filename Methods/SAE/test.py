...
dimz = 50
# test codes
model = models.SpatialAutoEncoder(32, 3).to(device)
...
model.load_weights_from_file('params/SAE_Cloth_prev_human12_dimZ_32')
...
plot_r.save_results_41(model, "SAE_mixedHR", mixedHR, "SAE mixedHR")
plot_r.save_results_41(model, "SAE_final_states", finalImages, "SAE final states")
...
# plot_r = pr.plot_task_map('../../Experiments/Dataset/Toy_Example', all_inputs, device)
# zts = plot_r.get_zts(model)
